...
def test_get_task(client, httpx_mock: HTTPXMock):
    httpx_mock.add_response(
        url="https://cloud.kaneo.app/api/task/task-xyz", json=TASK_DATA
    )
...
def test_update_status(client, httpx_mock: HTTPXMock):
    ...
    httpx_mock.add_response(
        url="https://cloud.kaneo.app/api/task/status/task-xyz", json=TASK_DATA
    )
    httpx_mock.add_response(
        url="https://cloud.kaneo.app/api/task/task-xyz", json=updated
    )
...
def test_update_priority(client, httpx_mock: HTTPXMock):
    ...
    httpx_mock.add_response(
        url="https://cloud.kaneo.app/api/task/priority/task-xyz", json=TASK_DATA
    )
    httpx_mock.add_response(
        url="https://cloud.kaneo.app/api/task/task-xyz", json=updated
    )
...
def test_update_title(client, httpx_mock: HTTPXMock):
    ...
    httpx_mock.add_response(
        url="https://cloud.kaneo.app/api/task/title/task-xyz", json=TASK_DATA
    )
    httpx_mock.add_response(
        url="https://cloud.kaneo.app/api/task/task-xyz", json=updated
    )
...
def test_update_description(client, httpx_mock: HTTPXMock):
    ...
    httpx_mock.add_response(
        url="https://cloud.kaneo.app/api/task/description/task-xyz", json=TASK_DATA
    )
    httpx_mock.add_response(
        url="https://cloud.kaneo.app/api/task/task-xyz", json=updated
    )
...
def test_invalid_priority_raises(client):
    with pytest.raises(ValueError, match="Invalid priority"):
        client.tasks.create(
            project_id=PROJECT_ID, title="x", priority="super-urgent", status="to-do"
        )
